      ...
      if (value !== this.state.valueOne) {
        this.setState(
          ...
          () => {
            ...
            const trackOneLength = this.state.positionOne;
            const trackThreeLength = twoMarkers ? this.props.sliderLength - this.state.positionTwo : 0;
            const trackTwoLength = this.props.sliderLength - trackOneLength - trackThreeLength;
            this.props.onPositionChange([trackOneLength, trackTwoLength, trackThreeLength]);
